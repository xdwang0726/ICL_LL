...
def main():
    ...
    parser.add_argument("--negative_first", action='store_true')
    parser.add_argument("--dataset", type=str, default="rotten_tomatoes")

    parser.add_argument("--dir", type=str, default="/data/v-xindiwang/ICL_LL/data_imbalance/")
    ...
    demonstration_data_dir = os.path.join(args.dir, args.dataset, "{}_16_100_test.jsonl".format(args.dataset))
