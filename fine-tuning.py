    ...
    for seed in seeds:
        ...
        if not args.label_imbalance:
            if args.correct == 100:
                ...
                para_path = os.path.join(args.para_dir, "noisy_label", args.gpt2, "{}_{}_correct".format(args.dataset, args.correct), "{}_{}_correct_{}.json".format(args.dataset, args.correct, seed))
        else:
            para_path = os.path.join(args.para_dir, "label_imbalance", args.gpt2, "{}_{}".format(args.dataset, args.imbalance_level), "{}_{}.json".format(args.dataset, seed))
